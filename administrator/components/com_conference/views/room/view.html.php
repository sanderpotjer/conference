 ...
 * @since       1.0
 */
class ConferenceViewRoom extends JViewLegacy
{
	/**
	...
	private function addToolbar()
	{
		...
		$isNew      = $this->item->conference_room_id === 0;
		$canDo      = $this->canDo;

		JToolbarHelper::title(JText::_('COM_CONFERENCE') . ' - ' . JText::_('COM_CONFERENCE_TITLE_ROOMS_EDIT'), 'list-view');
