 ...
 * @since       1.0
 */
class ConferenceViewRooms extends JViewLegacy
{
	/**
	...
	{
		JToolbarHelper::title(JText::_('COM_CONFERENCE') . ' - ' . JText::_('COM_CONFERENCE_TITLE_ROOMS'), 'page');
		...
		{
			JToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'rooms.delete');
		}
	}
}
