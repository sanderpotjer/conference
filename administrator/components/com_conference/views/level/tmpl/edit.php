            ...
            <div class="row-fluid">
                ...
                <div class="span7">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="title" id="title" class="span"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="label" id="label" class="span"
                                   value="<?php echo $this->item->label ?>"/>
                            <span class="help-block"><?php echo JText::_('COM_CONFERENCE_FIELD_LABEL_CLASS_DESC') ?></span>
                        </div>
                    </div>
                    <div class="control-group">
                ...
                <div class="span5">
                    <div class="well iteminfo">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input" name="created_by" id="created_by"
                                       value="<?php echo JFactory::getUser($this->item->created_by)->name; ?>"
                                       disabled="disabled"/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input" name="modified_by" id="modified_by"
                                       value="<?php echo JFactory::getUser($this->item->modified_by)->name; ?>"
                                       disabled="disabled"/>
                            </div>
                        </div>
                        <div class="control-group">
