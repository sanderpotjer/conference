 ...
 * @since       1.0
 */
class ConferenceViewLevel extends JViewLegacy
{
	/**
	...
	private function addToolbar()
	{
		...
		$isNew      = $this->item->conference_level_id === 0;
		$canDo      = $this->canDo;

		JToolbarHelper::title(JText::_('COM_CONFERENCE') . ' - ' . JText::_('COM_CONFERENCE_TITLE_LEVELS_EDIT'), 'list-view');
