 ...
 * @since       1.0
 */
class ConferenceViewLevels extends JViewLegacy
{
	/**
	...
	{
		JToolbarHelper::title(JText::_('COM_CONFERENCE') . ' - ' . JText::_('COM_CONFERENCE_TITLE_LEVELS'), 'stack');
		...
		{
			JToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'levels.delete');
		}
	}
}
